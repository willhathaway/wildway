...
function MobileHome(props) {
        ...
        return (
            ...
            <div className="mobileHome">
                ...
                <div className="mobileImg"><img className="mobileCupid" src={Cupid}></img></div>
                ...
                <Fade right>
                    ...
                    <div className="contentBlock block2">
                        ...
                        <p className="contentBlockText">A recent graduate of the Harvard Extension School's Full Stack Coding Bootcamp, I was awarded 'Most Likely To Inspire Young Developers' from my fellow classmates for my work during the course.</p>
                        <p className="contentBlockText">Having attended Hampshire College and one of the best Arts high schools in Massachusetts, I bring experience in both digital and fine art to my programming work.</p>

                    </div>
                    
                    </Fade>

                    <div className="mobileImg"><img className="mobileArtemis" src={Artemis}></img></div>
                    ...
                    <div className="mobileImg"><img className="mobileCentaur" src={Centaur}></img></div>
